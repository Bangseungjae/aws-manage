...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            System.out.println("  9. terminate instance          10. condor_status ");
    ...
    public static void condorStatus(String instance_id) {
        ...
        Target target = new Target().withKey("InstanceIds").withValues(instance_id);
        //Create ssm client.
...
//                .withTargets(target)
        ...
        do {
            ...
            if (status.equals("Success")) {
                ...
                //Process the output
                System.out.println("return : " + commandOutput);
            }
        ...
        if(!status.equals("Success")) {
            System.out.println("Fail Send Command");
        }
